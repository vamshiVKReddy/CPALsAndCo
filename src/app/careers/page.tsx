...
const openings = [
  {
    ...
    category: "Training",
    description:
      "We are seeking motivated candidates who have passed the CA Intermediate examination to join us as Article Assistants. You will gain exposure to audit, taxation, and advisory work under the guidance of experienced professionals.",
    requirements: [
      "CA Intermediate (Both groups passed)",
  ...
  },
  {
    ...
    category: "Audit",
    description:
      "We are looking for a qualified or semi-qualified CA with practical audit experience to join our audit team. The role involves conducting statutory and internal audits across various industries.",
    requirements: [
      "CA Qualified or CA Final (Either group)",
      "1–3 years of audit experience",
      "Knowledge of Companies Act and Standards on Auditing",
      "Attention to detail and integrity",
    ],
  },
  {
    title: "Tax & Compliance Executive",
    type: "Full-time",
    category: "Taxation",
    description:
      "We are seeking a professional with hands-on experience in direct and indirect taxation to join our compliance team. The role involves ITR filing, GST returns, and regulatory compliance for a diverse client portfolio.",
    requirements: [
      "B.Com / M.Com / CA Inter or Final",
      "Working knowledge of Income Tax and GST",
      "Experience with Tally and tax software",
  ...
  },
  {
    ...
    category: "Accounting",
    description:
      "We are looking for a meticulous accounts professional to maintain financial records for our clients, prepare financial statements, and support the audit and compliance teams.",
    requirements: [
...
const benefits = [
  {
    ...
    desc: "Structured learning paths, in-house training, and opportunities to work across diverse industries and service lines.",
    icon: "📈",
  },
  {
    title: "Mentorship",
    desc: "Direct mentorship from experienced Chartered Accountants and senior professionals on every engagement.",
    icon: "🎯",
  },
  {
    title: "Learning Culture",
    desc: "We invest in continuous professional development including seminars, webinars, and ICAI programmes.",
    icon: "📚",
  },
  {
    title: "Inclusive Environment",
    desc: "A respectful, collaborative workplace that values diverse perspectives and rewards merit.",
    icon: "🤝",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn delay={0.2}>
            <p className="text-slate-400 text-xl leading-relaxed max-w-2xl">
              Join a professional team that values integrity, expertise, and
              continuous growth. We offer meaningful work and real career
              development.
            </p>
          </FadeIn>
        </div>
      ...
      <section className="py-20 bg-white" aria-labelledby="why-join-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <FadeIn>
              <SectionLabel>Why CPALS & Co</SectionLabel>
            </FadeIn>
            <FadeIn delay={0.1}>
              <h2
                id="why-join-heading"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                <FadeIn delay={0.15}>
                  <p>
                    At CPALS & Co, we believe that our people are our most
                    valuable asset. We have cultivated a culture that combines
                    professional rigour with a supportive environment where
                    individuals can thrive and contribute meaningfully.
                  </p>
                </FadeIn>
                <FadeIn delay={0.2}>
                  <p>
                    Every team member is treated with respect, given
                    responsibility aligned to their abilities, and supported in
                    their professional development journey. We believe in
                    recognising effort and rewarding performance.
                  </p>
                </FadeIn>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: "Respect", desc: "Every person is valued" },
                { label: "Learning", desc: "Growth is continuous" },
                { label: "Accountability", desc: "Own your work" },
                { label: "Excellence", desc: "Quality in everything" },
              ].map((item) => (
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-1.5">
                        <span className="text-xs font-medium text-blue-600 bg-blue-50 border border-blue-100 px-2.5 py-0.5 rounded-full">
                          {job.category}
                        </span>
          ...
          <FadeIn>
            <div className="text-center mb-10">
              ...
              <p className="text-slate-600 mt-3">
                Interested in joining our team? Submit your details and we will
                be in touch.
              </p>
            </div>
          </FadeIn>
          <FadeIn delay={0.1}>
            <form className="bg-white rounded-2xl border border-slate-100 p-8 space-y-5" noValidate aria-label="Job application form">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  <label htmlFor="careers-name" className="block text-sm font-medium text-slate-700 mb-1.5">
                ...
                <div>
                  <label htmlFor="careers-email" className="block text-sm font-medium text-slate-700 mb-1.5">
              ...
              <div>
                <label htmlFor="careers-phone" className="block text-sm font-medium text-slate-700 mb-1.5">
                  Phone Number
                </label>
                <input
                  id="careers-phone"
              ...
              <div>
                <label htmlFor="careers-position" className="block text-sm font-medium text-slate-700 mb-1.5">
                  Position Applied For <span className="text-red-500" aria-hidden="true">*</span>
                </label>
                <select
                  id="careers-position"
                  name="position"
              ...
              <div>
                <label htmlFor="careers-qualification" className="block text-sm font-medium text-slate-700 mb-1.5">
                ...
                <textarea
                  ...
                  placeholder="Brief overview of your qualifications and relevant experience"
                />
              </div>
              <div>
                <label htmlFor="careers-cover" className="block text-sm font-medium text-slate-700 mb-1.5">
                  Cover Note
                </label>
                <textarea
                  id="careers-cover"
                  ...
                  rows={4}
                  className="w-full px-4 py-2.5 rounded-lg border border-slate-200 text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"
                  placeholder="Why you would like to join CPALS & Co"
                />
              </div>
              <button
                type="submit"
